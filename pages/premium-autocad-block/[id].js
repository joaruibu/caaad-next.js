...
import { urlTitle } from "../../helpers";


const BlockPage = ({ success, error, block, similarBlocks }) => {
  console.log(block)

  const { _id, dwg, description, description_ES, categories, filters, img, tags, title, title_ES } = block
    ...
    <Layout
      ...
      <main className='grid grid-cols-1 gap-9 md:grid-cols-[160px_1fr_160px] content-start md:gap-9 min-h-screen'>
        ...
        <div className='md:col-start-2 md:col-end-3 grid grid-rows-none grid-cols-1 xl:grid-cols-2 gap-12'>
          ...
          <div>
            <h1 className="text-5xl">Bloques de pagoooooooooo</h1>
            <div className="mb-4">
            ...
            <Link href={getUrlAfterPayment()} passHref={true} >
